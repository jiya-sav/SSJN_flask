...
# Initialize songs
def initSongs():
    # setup songs into a dictionary with id, song, sad, happy, Indian, rage
    item_id = 0
...
# Return all songs from song_data
def getSongs():
    return(song_data)
...
# Return random song from song_data
def getRandomSong():
...
if __name__ == "__main__": 
    initSongs()  # initialize songs
    
    # Most likes and most sad
    best = favoriteSong()
