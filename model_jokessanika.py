...
def initJokes():
    ...
    for item in song_list:
        song_data.append({"id": item_id, "joke": item, "haha": 0, "boohoo": 0})
        item_id += 1
...
def addJokeHaHa(id):
    song_data[id]['haha'] = song_data[id]['haha'] + 1
    return song_data[id]['haha']

# Add to boohoo for requested id
def addJokeBooHoo(id):
    song_data[id]['boohoo'] = song_data[id]['boohoo'] + 1
    return song_data[id]['boohoo']
